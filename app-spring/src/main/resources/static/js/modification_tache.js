(function() {
	...
	const piecesDejaAssociees = document.getElementById("piecesDejaAssociees");
	...
	if(piecesDejaAssociees.children.length > 0) {
		for(let i=0; i<piecesDejaAssociees.children.length; i++) {
			if(piecesDejaAssociees.children[i].getAttribute("type") == "checkbox") {
				piecesDejaAssociees.children[i].setAttribute("checked", "checked");
			}
		}
	}
